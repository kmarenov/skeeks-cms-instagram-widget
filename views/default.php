...
<? else: ?>
    <style type='text/css'>
        .instagram-widget {
            width: 260<?php /*echo $inWidget->width;*/ ?>px;
        ...
        .instagram-widget .title .text {
            float: left;
            width: 216<?php /*echo ($inWidget->width-44);*/ ?>px;
            height: 25px;
            overflow: hidden;
            margin: 5px 0 0 0;
            color: #FFF;
        ...
        .instagram-widget .data .image {
            ...
            float: left;
            margin: 0 5px 5px 0;
            width: <?php /*echo $inWidget->imgWidth;*/ ?>51px;
            height: <?php /*echo $inWidget->imgWidth;*/ ?>51px;
            overflow: hidden;
    ...
    <div class="instagram-widget">
        <a href="http://instagram.com/<?php echo $widget->user["username"]; ?>" target="_blank" class="title">
            <img
			...
			<table class="profile">
				<tr>
					<td rowspan="2" class="avatar">
						<a href="http://instagram.com/' . $widget->user["username"] . '" target="_blank"><img src="' . $widget->user["profile_picture"] . '"></a>
					</td>
					<td class="value">
				...
				<tr>
					<td colspan="3" style="border-right:none !important;">
						<a href="http://instagram.com/' . $widget->user["username"] . '" class="follow" target="_blank">' ./*$inWidget->lang['buttonFollow']*/
                'Посмотреть' . ' &#9658;</a>
					</td>
				</tr>
			</table>';
...
//            }
                echo '<a href="' . $item["link"] . '" class="image" target="_blank"><img src="' . $item["images"]["thumbnail"]["url"] ./*$thumbnail*/
                    '" alt="" /></a>';
            }
            echo '<div class="clear">&nbsp;</div>';
            echo '</div>';
        } else echo '<div class="empty">' ./*$inWidget->lang['imgEmpty']*/
            'у пользователя нет фотографии' . '</div>';
        ?>
    </div>
